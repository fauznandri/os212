...
[TARBALL](https://os.vlsm.org/Log/fauznandri.tar.bz2.txt) file.
...
| [TIPS]({{ site.baseurl }}/TIPS/) | [TARBALL](https://os.vlsm.org/Log/fauznandri.tar.bz2.txt) | [ZIP File]({{ site.baseurl }}/template.zip) |
